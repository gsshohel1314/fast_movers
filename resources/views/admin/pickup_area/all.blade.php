  ...
  <div class="col-md-12">
      <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <div class="row">
              <div class="col-md-8">
                <h3 class="panel-title"><i class="fa fa-cubes"></i> All Pick-Up Area Information</h3>
              </div>
              <div class="col-md-4 text-right">
                <a href="{{url('admin/pickup/area/create')}}" class="btn btn-sm btn-primary btn-panel-head"><i class="fa fa-th"></i> Add Pick-Up Area</a>
              </div>
              <div class="clearfix">
            </div>
            </div>
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                          <thead>
                              <tr>
                                  ...
                                  <th>Pick-Up Area Price Per KG</th>
                                  <th>Manage</th>
                              </tr>
                          </thead>
                          ...
                          <tbody>
                            ...
                            @foreach ($datas as $key => $data)
                              <tr>
                                  ...
                                  <td>{{$data->price}}</td>
                                  <td>
                                    <a class="btn btn-warning btn-sm" title="edit"  href="{{url('admin/pickup/area/create/'.$data->id)}}"><i class="fa fa-pencil-square fa-lg"></i></a>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form method="post" action="{{url('admin/pickup/area/softdelete')}}">
        @csrf
